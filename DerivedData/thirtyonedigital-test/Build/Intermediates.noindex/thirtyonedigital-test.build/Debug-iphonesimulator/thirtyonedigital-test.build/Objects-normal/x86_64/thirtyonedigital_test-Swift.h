...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="thirtyonedigital_test",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC21thirtyonedigital_test11AppDelegate")
...
SWIFT_CLASS("_TtC21thirtyonedigital_test13SceneDelegate")
...
SWIFT_CLASS("_TtC21thirtyonedigital_test18UserTableViewModel")
...
SWIFT_CLASS("_TtC21thirtyonedigital_test24UsersTableViewController")
...
@interface UsersTableViewController (SWIFT_EXTENSION(thirtyonedigital_test)) <UITableViewDelegate>
